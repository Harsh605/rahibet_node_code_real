...
module.exports = function (rummy_deal_socket, request, timer) {
        ...
        socket.on('get-table', msg => {
            ...
            UserModel.findOne({ where: { id: user_id, token: token, isDeleted: 0 } }).then(user => {
                if (user) {
                    ...
                    var options = {
                        'method': 'POST',
                        'url': 'https://admintesting.rahibet.com/api/rummyDeal/get_table',
                        'headers': {
                    ...
                    request(options, function (error, response) {
                        ...
                        if(numClients>1){
                            var options = {
                                'method': 'POST',
                                'url': 'https://admintesting.rahibet.com/api/rummyDeal/start_game',
                                'headers': {
                                    'token': 'c7d3965d49d4a59b0da80e90646aee77548458b3377ba3c0fb43d5ff91d54ea28833080e3de6ebd4fde36e2fb7175cddaf5d8d018ac1467c3d15db21c11b6909',
                                    'Cookie': 'ci_session=ql4u3d0569peintlo3clko0vftbg0ni2; ci_session=mmo9qqjgcpk00r04ll9dcqaohrir95pe'
                                },
        ...
        socket.on('get-private-table', msg => {
            ...
            UserModel.findOne({ where: { id: user_id, token: token, isDeleted: 0 } }).then(user => {
                if (user) {
                    ...
                    var options = {
                        'method': 'POST',
                        'url': 'https://admintesting.rahibet.com/api/rummyDeal/get_private_table',
                        'headers': {
                            'token': 'c7d3965d49d4a59b0da80e90646aee77548458b3377ba3c0fb43d5ff91d54ea28833080e3de6ebd4fde36e2fb7175cddaf5d8d018ac1467c3d15db21c11b6909',
                            'Cookie': 'ci_session=ql4u3d0569peintlo3clko0vftbg0ni2; ci_session=mmo9qqjgcpk00r04ll9dcqaohrir95pe'
                        },
        ...
        socket.on('join-table', msg => {
            ...
            UserModel.findOne({ where: { id: user_id, token: token, isDeleted: 0 } }).then(user => {
                if (user) {
                    ...
                    var options = {
                        'method': 'POST',
                        'url': 'https://admintesting.rahibet.com/api/rummyDeal/join_table',
                        'headers': {
                            'token': 'c7d3965d49d4a59b0da80e90646aee77548458b3377ba3c0fb43d5ff91d54ea28833080e3de6ebd4fde36e2fb7175cddaf5d8d018ac1467c3d15db21c11b6909',
                            'Cookie': 'ci_session=ql4u3d0569peintlo3clko0vftbg0ni2; ci_session=mmo9qqjgcpk00r04ll9dcqaohrir95pe'
                        },
        ...
        socket.on('join-table-with-code', msg => {
            ...
            UserModel.findOne({ where: { id: user_id, token: token, isDeleted: 0 } }).then(user => {
                if (user) {
                    ...
                    var options = {
                        'method': 'POST',
                        'url': 'https://admintesting.rahibet.com/api/rummyDeal/join_table_with_code',
                        'headers': {
                            'token': 'c7d3965d49d4a59b0da80e90646aee77548458b3377ba3c0fb43d5ff91d54ea28833080e3de6ebd4fde36e2fb7175cddaf5d8d018ac1467c3d15db21c11b6909',
                            'Cookie': 'ci_session=ql4u3d0569peintlo3clko0vftbg0ni2; ci_session=mmo9qqjgcpk00r04ll9dcqaohrir95pe'
                        },
            ...
            UserModel.findOne({ where: { id: user_id, token: token, isDeleted: 0 } }).then(user => {
                if (user) {
                    ...
                    request(options, function (error, response) {
                        ...
                        var body = JSON.parse(response.body);
                        if(body.game_id!==undefined){
                            rummy_deal_socket.in("room" + userData.rummy_deal_table_id).emit('trigger', "" + body.game_id);
                        }else{
                            rummy_deal_socket.in("room" + userData.rummy_deal_table_id).emit('trigger', "call_status");
                        }
        ...
        socket.on('leave-table', msg => {
            ...
            UserModel.findOne({ where: { id: user_id, token: token, isDeleted: 0 } }).then(user => {
                if (user) {
                    ...
                    var options = {
                        'method': 'POST',
                        'url': 'https://admintesting.rahibet.com/api/rummyDeal/leave_table',
                        'headers': {
                            'token': 'c7d3965d49d4a59b0da80e90646aee77548458b3377ba3c0fb43d5ff91d54ea28833080e3de6ebd4fde36e2fb7175cddaf5d8d018ac1467c3d15db21c11b6909',
                            'Cookie': 'ci_session=ql4u3d0569peintlo3clko0vftbg0ni2; ci_session=mmo9qqjgcpk00r04ll9dcqaohrir95pe'
                        },
                    ...
                    request(options, function (error, response) {
                        ...
                        var body = JSON.parse(response.body);
                        rummy_deal_socket.in("room" + table_id).emit('trigger', "call_status");
        ...
        socket.on('pack-game', msg => {
            ...
            UserModel.findOne({ where: { id: user_id, token: token, isDeleted: 0 } }).then(user => {
                if (user) {
                    ...
                    var options = {
                        'method': 'POST',
                        'url': 'https://admintesting.rahibet.com/api/rummyDeal/pack_game',
                        'headers': {
                            'token': 'c7d3965d49d4a59b0da80e90646aee77548458b3377ba3c0fb43d5ff91d54ea28833080e3de6ebd4fde36e2fb7175cddaf5d8d018ac1467c3d15db21c11b6909',
                            'Cookie': 'ci_session=ql4u3d0569peintlo3clko0vftbg0ni2; ci_session=mmo9qqjgcpk00r04ll9dcqaohrir95pe'
                        },
        ...
        socket.on('my-card', msg => {
            ...
            UserModel.findOne({ where: { id: user_id, token: token, isDeleted: 0 } }).then(user => {
                if (user) {
                    ...
                    var options = {
                        'method': 'POST',
                        'url': 'https://admintesting.rahibet.com/api/rummyDeal/my_card',
                        'headers': {
                            'token': 'c7d3965d49d4a59b0da80e90646aee77548458b3377ba3c0fb43d5ff91d54ea28833080e3de6ebd4fde36e2fb7175cddaf5d8d018ac1467c3d15db21c11b6909',
                            'Cookie': 'ci_session=ql4u3d0569peintlo3clko0vftbg0ni2; ci_session=mmo9qqjgcpk00r04ll9dcqaohrir95pe'
                        },
        ...
        socket.on('card-value', msg => {
            ...
            UserModel.findOne({ where: { id: user_id, token: token, isDeleted: 0 } }).then(user => {
                if (user) {
                    ...
                    var options = {
                        'method': 'POST',
                        'url': 'https://admintesting.rahibet.com/api/rummyDeal/card_value',
                        'headers': {
                            'token': 'c7d3965d49d4a59b0da80e90646aee77548458b3377ba3c0fb43d5ff91d54ea28833080e3de6ebd4fde36e2fb7175cddaf5d8d018ac1467c3d15db21c11b6909',
                            'Cookie': 'ci_session=ql4u3d0569peintlo3clko0vftbg0ni2; ci_session=mmo9qqjgcpk00r04ll9dcqaohrir95pe'
                        },
        ...
        socket.on('drop-card', msg => {
            ...
            UserModel.findOne({ where: { id: user_id, token: token, isDeleted: 0 } }).then(user => {
                if (user) {
                    ...
                    var options = {
                        'method': 'POST',
                        'url': 'https://admintesting.rahibet.com/api/rummyDeal/drop_card',
                        'headers': {
                            'token': 'c7d3965d49d4a59b0da80e90646aee77548458b3377ba3c0fb43d5ff91d54ea28833080e3de6ebd4fde36e2fb7175cddaf5d8d018ac1467c3d15db21c11b6909',
                            'Cookie': 'ci_session=ql4u3d0569peintlo3clko0vftbg0ni2; ci_session=mmo9qqjgcpk00r04ll9dcqaohrir95pe'
                        },
        ...
        socket.on('get-card', msg => {
            ...
            UserModel.findOne({ where: { id: user_id, token: token, isDeleted: 0 } }).then(user => {
                if (user) {
                    ...
                    var options = {
                        'method': 'POST',
                        'url': 'https://admintesting.rahibet.com/api/rummyDeal/get_card',
                        'headers': {
                            'token': 'c7d3965d49d4a59b0da80e90646aee77548458b3377ba3c0fb43d5ff91d54ea28833080e3de6ebd4fde36e2fb7175cddaf5d8d018ac1467c3d15db21c11b6909',
                            'Cookie': 'ci_session=ql4u3d0569peintlo3clko0vftbg0ni2; ci_session=mmo9qqjgcpk00r04ll9dcqaohrir95pe'
                        },
        ...
        socket.on('get-drop-card', msg => {
            ...
            UserModel.findOne({ where: { id: user_id, token: token, isDeleted: 0 } }).then(user => {
                if (user) {
                    ...
                    var options = {
                        'method': 'POST',
                        'url': 'https://admintesting.rahibet.com/api/rummyDeal/get_drop_card',
                        'headers': {
                            'token': 'c7d3965d49d4a59b0da80e90646aee77548458b3377ba3c0fb43d5ff91d54ea28833080e3de6ebd4fde36e2fb7175cddaf5d8d018ac1467c3d15db21c11b6909',
                            'Cookie': 'ci_session=ql4u3d0569peintlo3clko0vftbg0ni2; ci_session=mmo9qqjgcpk00r04ll9dcqaohrir95pe'
                        },
        ...
        socket.on('declare', msg => {
            ...
            UserModel.findOne({ where: { id: user_id, token: token, isDeleted: 0 } }).then(user => {
                if (user) {
                    ...
                    var options = {
                        'method': 'POST',
                        'url': 'https://admintesting.rahibet.com/api/rummyDeal/declare',
                        'headers': {
                            'token': 'c7d3965d49d4a59b0da80e90646aee77548458b3377ba3c0fb43d5ff91d54ea28833080e3de6ebd4fde36e2fb7175cddaf5d8d018ac1467c3d15db21c11b6909',
                            'Cookie': 'ci_session=ql4u3d0569peintlo3clko0vftbg0ni2; ci_session=mmo9qqjgcpk00r04ll9dcqaohrir95pe'
                        },
        ...
        socket.on('declare-back', msg => {
            ...
            UserModel.findOne({ where: { id: user_id, token: token, isDeleted: 0 } }).then(user => {
                if (user) {
                    ...
                    var options = {
                        'method': 'POST',
                        'url': 'https://admintesting.rahibet.com/api/rummyDeal/declare_back',
                        'headers': {
                            'token': 'c7d3965d49d4a59b0da80e90646aee77548458b3377ba3c0fb43d5ff91d54ea28833080e3de6ebd4fde36e2fb7175cddaf5d8d018ac1467c3d15db21c11b6909',
                            'Cookie': 'ci_session=ql4u3d0569peintlo3clko0vftbg0ni2; ci_session=mmo9qqjgcpk00r04ll9dcqaohrir95pe'
                        },
    ...
    function autochaal(room_id){
        var options = {
            'method': 'GET',
            'url': 'https://admintesting.rahibet.com/api/cron/rummy_deal_socket/'+room_id
        };
        request(options, function (error, response) {
            if (error) throw new Error(error);
            // console.log(response.body);
