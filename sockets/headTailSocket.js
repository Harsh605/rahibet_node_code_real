...
module.exports = function (head_tail_socket, request) {
    ...
    head_tail_socket.on('connection', (socket) => {
        if (!game_created) {
            ...
            var options = {
                'method': 'GET',
                'url': 'https://admin.tigonsclub.com/letscard/api/cron/head_tail_create_socket'
            };
    ...
    function timer_function() {
        ...
        if (timer <= 0) {
            ...
            var options = {
                'method': 'GET',
                'url': 'https://admin.tigonsclub.com/letscard/api/cron/head_tail_winner_socket'
            };
            request(options, function (error, response) {
                if (error) throw new Error(error);
                game_created = false;
                ...
                var options = {
                    'method': 'POST',
                    'url': 'https://admin.tigonsclub.com/letscard/api/headTail/get_active_game_socket',
                    'headers': {
